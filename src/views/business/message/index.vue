<template>
  <div class="app-container">
    <el-form
      ...
      label-width="68px"
    >
      <el-form-item label="资讯标题" prop="messageTitle">
        <el-input
      ...
      <el-form-item label="资讯类别" prop="classesId">
        <el-select v-model="queryParams.classesId" placeholder="请选择资讯类别">
          <el-option
            v-for="item in messageClassesList"
            :key="item.classesId"
    ...
    >
      ...
      <el-table-column label="资讯标题" align="center" prop="messageTitle" />
      <el-table-column label="类别名称" align="center" prop="classesName" />
      <el-table-column label="资讯内容" align="center" prop="messageContent" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="资讯标题" prop="messageTitle">
          <el-input v-model="form.messageTitle" placeholder="请输入资讯标题" />
        </el-form-item>
        <el-form-item label="资讯类别" prop="classesId">
          <el-select v-model="form.classesId" placeholder="请选择资讯类别">
            <el-option
              v-for="item in messageClassesList"
              :key="item.classesId"
              :label="item.classesName"
...
import { listAllClasses } from "@/api/business/classes";
...
export default {
  ...
  created() {
    this.getList();
    //查询全部资讯列表列表
    listAllClasses().then((response) => {
      this.messageClassesList = response.data;
    });
  },
  methods: {
    /** 查询资讯管理列表 */
